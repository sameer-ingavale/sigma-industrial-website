  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <a
        ...
        className="border border-gray-300 rounded-md p-2 hover:border-trust text-gray-700 hover:text-trust"
      >
        <WhatsAppIcon />
      </a>
      <a
        ...
        className="border border-gray-300 rounded-md p-2 hover:border-navy text-gray-700 hover:text-navy"
      >
        <EmailIcon />
      </a>
    </div>
