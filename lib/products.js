...
export const products = [
	{
		slug: "ss-304-wire-mesh",
		name: "SS304 Wire Mesh",
		categories: ["filters-filtration-elements"],
		...
		moq: "1 roll",
		indicativePrice: "$800",
		industries: ["Mining", "Chemicals", "Food & Beverage", "Petrochemicals"],
		...
		faqs: [
			{
				question: "Can this mesh be supplied in custom sizes or cut pieces?",
				answer:
					"Yes. Depending on the requirement, the mesh can be supplied as a full roll or converted into cut panels, screens, or other dimensions. Please provide the required dimensions and quantity when requesting a quotation.",
			},
			{
				question:
					"Can you supply equivalent wire mesh against an existing screen specification?",
				answer:
					"Yes. We can review an existing mesh sample, drawing, specification, or equipment requirement and supply a technically matching or suitable equivalent, subject to confirming the required mesh opening, wire diameter, material grade, and dimensions.",
			},
		],
	},

	{
		slug: "refractory-firebricks",
		name: "Refractory Firebricks",
		...
		moq: "672 bricks",
		indicativePrice: "$500",
		industries: ["Steel", "Aluminium", "Glass", "Ceramics", "Foundries"],

		datasheetUrl: false,
		drawingUrl: false,
		testCertificateUrl: "/documents/industrial-firebricks-test-certificate.pdf",
		catalogueUrl: false,
	...
	{
		slug: "leader-globe-valve",
		name: "Leader Globe Valve",
		categories: ["valves-flow-control"],
		...
		application:
			"Regulates or isolates steam, water, oil, gas, and other process fluids in industrial piping systems.",
		...
		datasheetUrl:
			"/documents/leader-globe-valve-2-inch-300-class-datasheet.pdf",
		drawingUrl: "/documents/leader-globe-valve-2-inch-300-class-drawing.pdf",
		testCertificateUrl: false,
		catalogueUrl: false,
	...
	{
		slug: "leader-blowdown-valve",
		name: "Leader Blowdown Valve",
		...
		application:
			"Controls boiler blowdown discharge to remove concentrated dissolved solids, sludge, and contaminants from boiler systems.",
		...
		datasheetUrl:
			"/documents/leader-blowdown-valve-2-inch-300-class-datasheet.pdf",
		drawingUrl: "/documents/leader-blowdown-valve-2-inch-300-class-drawing.pdf",
		testCertificateUrl: false,
		catalogueUrl: false,
	...
	{
		slug: "champion-style-54-super-metallic-gasket-sheet",
		name: "Champion Style 54 Super Metallic Gasket Sheet",
		...
		datasheetUrl:
			"/documents/champion-style-54-super-metallic-gasket-datasheet.pdf",
		drawingUrl: false,
		testCertificateUrl: false,
		catalogueUrl:
			"/documents/champion-style-54-super-metallic-gasket-catalogue.pdf",

		faqs: [],
	},

	{
		slug: "suntec-fuel-pump",
		name: "Suntec Fuel Pump",
	...
	{
		slug: "industrial-insulation-jackets",
		name: "Industrial Insulation Jackets",
		categories: ["general-industrial-products"],
	...
	{
		slug: "bonfiglioli-worm-gearbox",
		name: "Bonfiglioli Worm Gearbox",
		categories: ["general-industrial-products"],
		...
		datasheetUrl: "/documents/bonfiglioli-w75-worm-gearbox-datasheet.pdf",
		drawingUrl: "/documents/bonfiglioli-w75-worm-gearbox-drawing.pdf",
		testCertificateUrl: false,
		catalogueUrl: false,
	...
	{
		slug: "hanna-hi83399-multiparameter-photometer",
		name: "Hanna HI83399 Multiparameter Photometer with Digital pH Meter",
	...
	{
		slug: "grundfos-pump",
		name: "Grundfos Pump with Motor and Base Plate",
		...
		datasheetUrl: "/documents/grundfos-nk32-160-177-pump-datasheet.pdf",
		drawingUrl: false,
		testCertificateUrl: false,
		catalogueUrl: false,
...

	{
		...
		name: "Shell Tellus S2 MX 46 Lubricant",
		...
		datasheetUrl: "/documents/shell-tellus-s2-mx-46-datasheet.pdf",
		drawingUrl: false,
		testCertificateUrl: "/documents/shell-tellus-s2-mx-46-test-certificate.pdf",
		catalogueUrl: false,
	...
	{
		slug: "nido-manual-drum-stacker-tilter",
		name: "Nido Manual Drum Stacker Tilter",
		categories: ["general-industrial-products"],
		...
		datasheetUrl: "/documents/nido-manual-drum-stacker-tilter-datasheet.pdf",
		drawingUrl: false,
		testCertificateUrl: false,
		catalogueUrl: false,
	...
	{
		slug: "equitron-laboratory-incubator",
		name: "Equitron Laboratory Incubator",
		categories: ["laboratory-testing-equipment"],
		...
		datasheetUrl:
			"/documents/equitron-7251-091-laboratory-incubator-datasheet.pdf",
		drawingUrl: false,
		testCertificateUrl: false,
		catalogueUrl: false,
	...
	{
		slug: "equitron-autoclave",
		name: "Equitron Autoclave",
		categories: ["laboratory-testing-equipment"],
		...
		datasheetUrl: "/documents/equitron-7451slefa-15psi-autoclave-datasheet.pdf",
		drawingUrl: false,
		testCertificateUrl: false,
		catalogueUrl: false,
