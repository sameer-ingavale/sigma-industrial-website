...
export const products = [
	...
	{
		slug: "servo-controlled-voltage-stabilizer",
		name: "Servo Controlled Voltage Stabilizer",
		categories: ["general-industrial-products"],
		image: "/images/products/servo-controlled-voltage-stabilizer.png",

		brand: "fuji-electric",
		crossReferenceBrands: ["Servokon", "Servomax", "Purevolt"],
		modelNumber: null,
		partNumbers: [],
		...
		application:
			"Automatically regulates voltage and protects sensitive industrial and electrical equipment from input voltage fluctuations.",

		specifications: [
			{ label: "Rated Capacity", value: "125 kVA" },
			{ label: "Cooling", value: "Natural Air-Cooled" },
			{ label: "Input Voltage Range", value: "360–460 V AC, 3 Phase" },
			{ label: "Output Voltage", value: "415 V AC, 3 Phase" },
			{ label: "Correction Speed", value: "16.6–70 V/sec" },
		...
		datasheetUrl:
			"https://pub-8ff9c573aae247689bd1ffe8bac21ffb.r2.dev/servo-controlled-voltage-stabilizer-ds.pdf",
		drawingUrl: false,
		testCertificateUrl: false,
		catalogueUrl: false,
		...
		faqs: [
			{
				question: "How do I determine the required stabilizer capacity?",
				answer:
					"Calculate the maximum simultaneous load in kVA, accounting for motor starting/inrush currents, and add around 20–30% capacity for future expansion. For example, a 100 kVA simultaneous load would typically require a 125 kVA stabilizer.",
			},
			{
				question: "What cooling options are available?",
				answer:
					"Air-cooled servo stabilizers are available in natural and forced-air cooled configurations. The suitable cooling arrangement depends on the stabilizer capacity, installation environment, and operating conditions.",
			},
			{
				question: "Which stabilizer parameters can be adjusted?",
				answer:
					"Input voltage band, output voltage, voltage sensitivity, over/under-voltage cut-offs, overload protection, and trip time delays can be configured through the front-panel keypad.",
			},
		],
	},
	{
		slug: "led-highbay-light-80w",
		name: "LED Highbay Light 80W",
		categories: ["lighting-illumination"],
		image: "/images/products/led-highbay-light-80w.png",
		...
		modelNumber: "BY225P LED100S CW WB PSU FG GR V1",
		partNumbers: [],

		status: "sourced-on-demand",

		application:
			"High-bay lighting for industrial facilities, warehouses, manufacturing areas, and other indoor high-ceiling applications.",

		specifications: [
			{ label: "Power Consumption", value: "80 W" },
			{ label: "Luminous Flux", value: "10,500 lm" },
			{ label: "Luminous Efficacy", value: "131.25 lm/W" },
			{ label: "Color Temperature", value: "6500 K (Cool Daylight)" },
			{ label: "Beam Angle", value: "110° Wide Beam" },
			{ label: "Input Voltage", value: "140–270 V AC" },
			{ label: "Housing", value: "Die-cast Aluminum" },
			{ label: "Mounting", value: "Eye-Bolt" },
		],
		...
		datasheetUrl:
			"https://pub-8ff9c573aae247689bd1ffe8bac21ffb.r2.dev/led-highbay-light-80w-ds.pdf",
		drawingUrl:
			"https://pub-9f058620294c434aae836f36d8761333.r2.dev/led-highbay-light-80w-ds.pdf",
		testCertificateUrl:
			"https://pub-db901b1dcba8452aa7682105f4e2eb9e.r2.dev/led-highbay-light-80w-tc.pdf",
		catalogueUrl: false,

		faqs: [
			{
				question: "Can you provide lighting design and layout support?",
				answer:
					"Share the area dimensions, mounting height, application, and required illumination level (lux). We can then calculate the required lighting level, recommend the appropriate fixture, and propose the number, spacing, and layout of lights to achieve the required illumination with suitable uniformity.",
			},
		],
	},
	{
		slug: "standalone-sticker-label-applicator",
		name: "Standalone Sticker Label Applicator",
		categories: ["general-industrial-products"],
		image: "/images/products/standalone-sticker-label-applicator.png",
		brand: "sigma-verified-manufacturer",
		modelNumber: "",
		partNumbers: [],
		status: "made-to-order",
		application:
			"Automatic application of self-adhesive hologram and sticker labels on bottles and other suitable products.",
		specifications: [
			{ label: "Labelling Speed", value: "Up to 300 bottles/min" },
			{ label: "Label Width / Height", value: "8–95 mm" },
			{ label: "Label Length", value: "20–500 mm" },
			{ label: "Labelling Accuracy", value: "±0.5–0.75 mm on label dispenser" },
			{ label: "Dispenser Motor", value: "Fuji, 400 W servo motor" },
			{ label: "HMI", value: "7-inch colour touchscreen" },
			{ label: "Label Sensor", value: "Di-soric slot sensor" },
			{ label: "Product Sensor", value: "Leuze" },
			{ label: "Encoder", value: "Leuze, 5000 PPR" },
			{
				label: "Power Supply",
				value: "220/240 V AC, 50 Hz, single phase",
			},
		],
		hsCode: "84223000",
		countryOfOrigin: "India",
